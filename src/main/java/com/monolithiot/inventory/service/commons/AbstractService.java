...
public interface AbstractService<T extends AbstractEntity> {
     ...
     * @param e 实体对象
     */
    <O extends T> void resolvePath(O e);
     ...
     * @return entity list
     */
    default <O extends T> List<T> resolvePath(List<T> source) {
     ...
     */
    default <O extends T> void resolvePath(PageInfo<T> source) {
